...
const closeItem = ()=>{
    ...
    closeTimeline.addLabel('start', 0).addLabel('typeTransition', 0.5).addLabel('showItems', typeT.out().totalDuration() * 0.7 + closeTimeline.labels.typeTransition).to(backCtrl, {
        ...
        y: '50%',
        stagger: -0.04
    }, 'start').to(item.article.DOM.imageWrap, {
        duration: 1,
        ease: 'power4.in',
        y: '100%'
    }, 'start').to(item.article.DOM.image, {
        duration: 1,
        ease: 'power4.in',
        y: '-100%'
...
_propagateYoyoEase = function _propagateYoyoEase(timeline, isYoyo) {
    ...
    p2 = (period || (type ? 0.3 : 0.45)) / (amplitude < 1 ? amplitude : 1), p3 = p2 / _2PI * (Math.asin(1 / p1) || 0), easeOut = function easeOut(p) {
 ...
 */ var _gsap = {
    ...
    quickSetter: function quickSetter(target, property, unit) {
        ...
        var Plugin = _plugins[property], cache = _getCache(target), p = cache.harness && (cache.harness.aliases || {
